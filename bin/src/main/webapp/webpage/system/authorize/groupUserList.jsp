...
<t:datagrid name="userList" title="common.operation"
	actionUrl="functionGroupController.do?groupUser&groupId=${groupId}"
...
<a class="easyui-linkbutton l-btn l-btn-plain"
	style="position: absolute; top: 40px" onclick="openSelectSort()"> <i
	class="fa fa-plus"></i><span class="bigger-110 no-text-shadow">
		添加用户</span>
</a>
<script>
    $(function() {
