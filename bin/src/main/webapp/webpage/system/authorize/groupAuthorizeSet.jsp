	...
	<div id="divUserList" class="easyui-layout" style="width: 100%;">
		...
		<div data-options="region:'center'">
			<t:datagrid checkbox="true" name="userLists"
				...
				actionUrl="functionGroupController.do?userDataGrid" fit="true"
				...
				<t:dgFunOpt funname="openAuthorizeSet(userName)" title="分配权限组"
					urlclass="ace_button" urlfont="fa-cog"
					urlStyle="background-color:#18a689;"></t:dgFunOpt>
			</t:datagrid>
		</div>
	</div>
	<div region="east" title="当前权限组" style="width: 300px;" split="true"
