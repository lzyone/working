		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><select name="buttonStyle" id="buttonStyle">
						...
						<option value="button"
							<c:if test="${cgformButtonPage.buttonStyle=='button'}">selected="selected"</c:if>>button</option>
				</select> <span class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label"> <t:mutiLang
							langKey="common.action.type" />:
				</label></td>
				<td class="value"><select name="optType" id="optType">
						<option value="js"
							<c:if test="${cgformButtonPage.optType=='js'}">selected="selected"</c:if>>js</option>
						<option value="action"
							<c:if test="${cgformButtonPage.optType=='action'}">selected="selected"</c:if>>action</option>
				</select> <span class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label"> <t:mutiLang
							langKey="common.show.sequence" />:
				</label></td>
				<td class="value"><input class="inputxt" id="orderNum"
					name="orderNum" datatype="n" value="${cgformButtonPage.orderNum}">
					<span class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label"> <t:mutiLang
							langKey="common.show.icon.style" />:
				</label></td>
				<td class="value"><input class="inputxt" id="buttonIcon"
					name="buttonIcon" datatype="*"
			...
			<tr>
				<td align="right"><label class="Validform_label"> <t:mutiLang
							langKey="common.show.expression" />:
				</label></td>
				<td class="value"><input class="inputxt" id="exp" name="exp"
					ignore="ignore" value="${cgformButtonPage.exp}"> <span
					class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label"> <t:mutiLang
				...
				<td class="value"><select name="buttonStatus" id="buttonStatus">
						<option value="0"
							<c:if test="${cgformButtonPage.buttonStatus=='0'}">selected="selected"</c:if>><t:mutiLang
								langKey="common.inactive" /></option>
						<option value="1"
							<c:if test="${cgformButtonPage.buttonStatus=='1'}">selected="selected"</c:if>><t:mutiLang
								langKey="common.active" /></option>
				</select> <span class="Validform_checktip"></span></td>
			</tr>
		</table>
	</t:formvalid>
