		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value"><select name="cgJsType" id="cgJsType">
						...
						<option value="list"
							<c:if test="${cgformenhanceJsPage.cgJsType=='list'}">selected="selected"</c:if>>list</option>
			...
			<tr>
				...
				<td class="value"><textarea id="cgJsStr" name="cgJsStr"
						cols="130" rows="30">${cgformenhanceJsPage.cgJsStr}</textarea> <span
