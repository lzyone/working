		...
		<tbody>
			<tr>
				...
				<td class="value">
					...
					<t:upload name="instruction" dialog="false" multi="false" extend=""
						...
						formData="documentTitle"></t:upload> <!-- update--end--author:zhangjiaqiang date:20170601 for:切换上传资源的保存路径 -->
				</td>
			</tr>
			<tr>
