...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="jeecgDemoList" checkbox="true"
			...
			title="列表多表头例子" actionUrl="jeecgListDemoController.do?datagrid"
			...
			<t:dgCol title="工资" field="salary" rowspan="2" queryMode="group"
				width="120"></t:dgCol>
			<t:dgCol title="入职状态" field="status" rowspan="2" query="true"
			...
			<t:dgCol title="创建日期" field="createDate" rowspan="2"
				formatter="yyyy-MM-dd" query="true" queryMode="group"
